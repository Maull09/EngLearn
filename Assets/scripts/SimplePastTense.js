...
// Exit button to reset the quiz and redirect to Simple Past Tense section
document.getElementById('exit-button').addEventListener('click', function () {
  currentQuestion = 0;
  updateQuestion();
  updateProgressBar();
  feedback.textContent = ''; // Clear any feedback
  window.location.href = "../main.html#simplePastTense"; // Redirects to Simple Past Tense section
});
